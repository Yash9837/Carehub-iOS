        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            ...
            let mockLabTech = LabTechnician1(
                ...
                joinDate: {
                    ...
                    return formatter.date(from: "April 26, 2025 at 10:32:09 PM UTC+5:30") ?? Date()
                }()
            )
            ...
            List {
                if viewModel.isLoading {
                    ...
                    Section(header: Text("Account Details")) {
                        ...
                        LabeledContent("Joined", value: labTech.joinDate.formatted(date: .abbreviated, time: .shortened))
                    }
